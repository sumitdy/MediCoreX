...
The AI feature follows a service-based architecture.
...
Docker Compose maps this environment variable to:
Gemini__ApiKey
...
| POST | `/api/Ai/patient-summary` | Generate AI-based patient summary |
